...
ffi.cdef("""
    ...
    int unur_distr_cont_set_pdf(UNUR_DISTR distribution, double (*pdf)(double, const struct unur_distr*));
    int unur_distr_cont_set_dpdf(UNUR_DISTR distribution, double (*dpdf)(double, const struct unur_distr*));
    int unur_distr_cont_set_cdf(UNUR_DISTR distribution, double (*cdf)(double, const struct unur_distr*));
    ...
    int unur_distr_discr_set_pmf(UNUR_DISTR distribution, double (*pmf)(int, const struct unur_distr*));
