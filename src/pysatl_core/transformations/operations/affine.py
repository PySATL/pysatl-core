...
class AffineDistribution(DerivedDistribution):
    ...
    def sample(self, n: int, **options: Any) -> NumericArray:
        ...
        The method samples ``X`` from the lightweight base distribution using
        the currently attached sampling strategy and returns ``aX + b``.
        """
    ...
    def _build_analytical_computations(
        ...
        *,
        ...
        bases : Mapping[ParentRole, LightweightDistribution]
            Lightweight parent distributions grouped by logical role.
        ...
        tuple[
            ...
            Labeled analytical computations and loop analytical flags.
        ...
        RuntimeError
            If no transformed characteristic is eligible to be attached.
        """
        computations: dict[
        ...
        _register(
            ...
            self._requirements(CharacteristicName.CF),
            self._make_cf,
        )
        _register(
            CharacteristicName.MEAN,
            self._requirements(CharacteristicName.MEAN),
            self._make_mean,
        )
        _register(
            CharacteristicName.VAR,
            self._requirements(CharacteristicName.VAR),
            self._make_var,
        )
        _register(
            CharacteristicName.SKEW,
            self._requirements(CharacteristicName.SKEW),
            self._make_skew,
        )
        _register(
        ...
        if kind == Kind.CONTINUOUS:
            ...
            _register(
                ...
                self._requirements(CharacteristicName.PDF),
                self._make_continuous_pdf,
            )
            _register(
                CharacteristicName.PPF,
                self._requirements(CharacteristicName.PPF),
        ...
        if kind == Kind.DISCRETE:
            _register(
                ...
                self._requirements(CharacteristicName.PMF),
